...
Flag pictures: Twemoji by Twitter, licensed CC-BY 4.0 (creativecommons.org/licenses/by/4.0/). Used unchanged apart from being embedded in the page.

Music notation shapes (the treble clef, sharp and flat signs drawn on the stave): outlines taken from the Bravura music font,
Copyright (c) 2015, Steinberg Media Technologies GmbH (http://www.steinberg.net/), with Reserved Font Name "Bravura".
Bravura is licensed under the SIL Open Font License, Version 1.1. The outlines are used as scalable drawings inside the page,
with no changes to their shapes, and this notice and the full licence are kept here as the licence requires. The full text follows.
